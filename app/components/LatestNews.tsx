          ...
          {articles.map((article) => (
            ...
            >
                ...
                {article.isVideo && (
                  <div className="absolute inset-0 flex items-center justify-center bg-black/20">
                    <div className="w-16 h-16 bg-white/90 rounded-full flex items-center justify-center hover:bg-white transition-colors cursor-pointer">
                      <svg
                        className="w-8 h-8 text-[#AB8E66] ml-1"
                        fill="currentColor"
                        viewBox="0 0 24 24"
                      >
              ...
              <div className="p-5 md:p-6">
                ...
                <a
                  href="#"
                  className="inline-block text-black font-bold text-sm md:text-base hover:text-[#AB8E66] transition-colors relative group"
                >
                  READ MORE
                  <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#AB8E66] group-hover:w-full transition-all duration-300"></span>
                </a>
              </div>
            </article>
          ))}
