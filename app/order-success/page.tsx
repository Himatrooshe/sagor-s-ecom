    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="container mx-auto px-4 py-8 md:py-16">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="bg-gray-50 rounded-lg p-4 md:p-6 mb-6 md:mb-8">
            ...
            <div className="space-y-2 md:space-y-3 text-left">
              <div className="flex items-start gap-2 md:gap-3">
                <div className="w-5 h-5 md:w-6 md:h-6 bg-[#10192E] text-white rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
          ...
          {/* Contact Info */}
          <div className="bg-[#10192E] text-white rounded-lg p-4 md:p-6 mb-6 md:mb-8">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <a 
                ...
                className="flex items-center justify-center gap-2 bg-white text-[#10192E] px-4 md:px-6 py-2 rounded-lg font-semibold hover:bg-gray-100 transition-colors text-sm md:text-base"
              >
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3 md:gap-4">
            <Link
              href="/shop"
              className="bg-[#10192E] text-white px-6 md:px-8 py-2 md:py-3 rounded-lg font-semibold hover:bg-[#1a2744] transition-colors text-sm md:text-base text-center"
            >
              Continue Shopping
            </Link>
            <Link
              href="/"
              className="bg-white text-[#10192E] px-6 md:px-8 py-2 md:py-3 rounded-lg font-semibold border-2 border-[#10192E] hover:bg-gray-50 transition-colors text-sm md:text-base text-center"
            >
              Back to Home
            </Link>
          </div>
